...
const ManageCoupons = () => {
  ...
  // Fetch Coupons
  useEffect(() => {
    fetch(`https://product-hunt-server-eight-flax.vercel.app/products/api/coupons`)
      .then(res => res.json())
  ...
  const handleAddCoupon = async (e) => {
    e.preventDefault();
    const res = await fetch(`https://product-hunt-server-eight-flax.vercel.app/products/api/coupons`, {
      method: 'POST',
  ...
  const handleDelete = async (id) => {
    await fetch(`https://product-hunt-server-eight-flax.vercel.app/products/api/coupons/${id}`, { method: 'DELETE' });
