...
const ProductEdit = () => {
  ...
  const handleUpdate = async () => {
    ...
    try {
      const response = await axios.patch(`https://product-hunt-server-tawny.vercel.appproducts/${id}`, formData, {
  ...
  return (
    <div className="max-w-lg mx-auto p-4 bg-white shadow rounded">
      ...
      {product.image && (
        <img
          src={imageFile ? URL.createObjectURL(imageFile) : `https://product-hunt-server-tawny.vercel.appuploads/${product.image}`}
          alt="Product"
